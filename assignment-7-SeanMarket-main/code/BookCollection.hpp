...
class BookCollection : public BookCollectionBase {
    ...
    public:
        ...
        Book* removeHelper(Book* node, string bookName);
        Book* findLowest(Book* node);
        Book* rotateHelper(Book* node, string bookName);
        Book* findoldparent(Book* node, string book1, string book2);
        ...
        void deleteCollection(Book *B);
        void insert(Book *&parent, Book *&child);
        void inOrdPrint(Book *B);
        void destroybooks(Book* node);
        Book* search(Book *B, string bookName);
        void byAuthor(Book *B, string author);
        double highestRated(Book *B, double &highestRating);
        void highestRatedPrint(Book *B, double highestRating);
        int height(Book *B);
};
