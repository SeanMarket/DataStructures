...
class BookCollection {
    ...
    public:
        ...
        void insertBook(Book *&parent, Book *&child);
        void inOrderPrint(Book *B);
        Book* search(Book *B, string bookName);
        void byAuthorHelper(Book *B, string author);
        double highestRatedHelper(Book *B, double &highestRating);
        void highestRatedHelperPrint(Book *B, double highestRating);
        int heightHelper(Book *B);
};
